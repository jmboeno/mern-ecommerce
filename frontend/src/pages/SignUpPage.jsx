...
const SignUpPage = () => {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			toast.success(res.message); // Exibe a mensagem "check your email"
			navigate("/login"); // Redireciona para o login após o cadastro
		} catch (error) {
			// O erro é tratado no store, mas mantemos o catch para fluxos inesperados
			// O toast.error já é tratado no store, mas podemos mostrar aqui o erro da rede
